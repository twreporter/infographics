  ...
  return (
    <div>
        <div className={styles["ending-wrapper"]}>
          <a target="_blank" href="https://www.twreporter.org/topics/far-sea-fishing-investigative-report">
          ...
          <ReactCSSTransitionGroup
            ...
            <div className={styles["links-box"]}>
              <div className={styles["grid-left"]}>
                <a target="_blank" href="https://www.twreporter.org/a/far-sea-fishing-indonesia-agency">
                ...
                <a target="_blank" href="https://www.twreporter.org/a/far-sea-fishing-indonesia-fishermen-death">
                  <div className={ styles["related-item"] }>
                    <div className={ styles["related-left"] }>
              ...
              <div className={styles["grid-right"]}>
                <div>
                  ...
                  <p className={styles["reporter-logo"]}>
