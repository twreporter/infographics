        ...
        <nav>
          ...
          <div className={ classnames(styles.header) }>
            ...
            <div className={ styles["share-box"] }>
              <a href="https://www.twreporter.org/a/photoessay-far-sea-fishing/" style={ { opacity: 0.65, marginRight: "0.5rem" } } target="_blank">
                <div title="Traditional Chinese - 【圖文故事】離岸之前——印尼漁工的台灣夢" className={ classnames(commonStyles["img-responsive"], styles["nav-icon"]) }
