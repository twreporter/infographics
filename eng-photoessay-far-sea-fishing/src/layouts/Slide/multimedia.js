...
export const TEXT = [
  ...
  "Every year, there are more than five thousand people get on Taiwan’s fishing boats from here.",
  null,
  "Eighty percent of the male residents of the fishing village near the port work on Taiwan’s fishing boats.",
  "There are trellises full of sun-dried fishes, and the task is mainly attributed to the women staying in the village.",
  "The daily meal is simple, including a crab and a bowl of rice.",
  "The clothes hung out in front of the doors are full of colors; men are obviously absent from the family.",
  "Men’s absence is to achieve Taiwanese dream with three-thousand-dollar monthly pay. After several years’ hard working, they are capable of acquiring new houses with sparkling tiles.",
  "However, not everyone has good luck. Murder crime on the Te Hung Hsing No. 368 happened three years ago. The Indonesian fishermen killed the captain resulting from his violent exertion, and were given heavy jail sentence. Henceforth, they are unable return home.",
  "Here is Visa’s home, with unfinished tiles. In 2013, Visa were sentenced to 28 years in prison by cause of Murder crime on the Te Hung Hsing. His family had no income immediately.",
  ...
  "Each child in this village may become a fisherman and work for Taiwanese in the future.",
  null,
  "The local people who help agency to recruit fishermen in villages are called “buffalo”.",
  "The buffalo, Ade, had worked on Taiwan’s far-sea fishing boats for six years and then became undocumented migrant. He was repatriate to Indonesia and worked as buffalo. He can earn 10 dollars bonus for each fisherman he recruit.",
  "In order to apply for working on Taiwan’s far-sea fishing boats, you have to submit five documents. The payment of application is too expense for the fishermen. Indonesian government covets the huge profit and doesn’t eradicate the overissue and fake of documents except for passports.",
  "For the fishermen, it doesn’t matter if they get illegal documents. They are desperately to realize their Taiwanese dream.",
  null,
  "The fishermen first arrive in Kaohsiung International Airport in Taiwan, The agency pick them up with 9 passenger van.",
  "The man responsible for pick-up says that if a group of five or six people with black skin walk from the entry gate, they should be the fishermen.",
  "The van seems like a portable cage keeping them from the outside world.",
